...
description: Tibetan Spirit product taxonomy, authenticity markers, and category expertise sourced from spiritual-director. Load this skill when answering product questions, creating product descriptions, evaluating new products for sourcing, or helping customers choose items for their practice. Also load for category management decisions about assortment and pricing.
version: "0.1.0"
category: shared
tags: [products, taxonomy, authenticity]
...
This skill encodes the product expertise of the Tibetan Spirit team, particularly spiritual-director's deep knowledge of Buddhist sacred items and operations-manager's sourcing experience in Nepal.
...
1. **Provenance**: Where was it made? By whom? Can we verify the supply chain?
   ...
   - New supplier, samples validated by spiritual-director (medium confidence)
...
3. **Practice Alignment**: Is this item genuinely useful for Buddhist practice?
   ...
   - When in doubt, spiritual-director makes the final call

## Sourcing Network

- **Primary**: Kathmandu Valley workshops (operations-manager manages relationships, quarterly visits)
...
## Questions to Escalate to spiritual-director
