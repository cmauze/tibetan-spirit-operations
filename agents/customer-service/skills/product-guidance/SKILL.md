...
description: Help customers choose products by matching their questions to the product knowledge base. Use this skill when a customer asks about product selection, sizing, materials, practice suitability, or comparisons between items. Escalates Buddhist practice questions to spiritual-director. Never pushy or sales-oriented — guide through knowledge, not persuasion.
version: "0.1.0"
category: customer-service
tags: [products, recommendations, practice]
...
4. **Escalating practice questions** to spiritual-director when they go beyond product selection
...
1. What type of question is this?
   ...
   d. PRACTICE_SUITABILITY — "Can I use this for Vajrayana practice?"
      ...
      -> If about Buddhist doctrine or meditation instruction: ESCALATE to spiritual-director
      -> If about cultural appropriation concerns: ESCALATE to spiritual-director
...
2. Does this question touch on Buddhist doctrine or meditation practice?
   -> "How do I use a mala for mantra practice?" = ESCALATE to spiritual-director
   -> "How many beads are on a full mala?" = ANSWER (factual product info)
   -> "Which deity should I choose for my practice?" = ESCALATE to spiritual-director
...
## Practice Question Escalation to spiritual-director

When escalating to spiritual-director, send an email with full context:
...
- Recommendation responses (2-3 product suggestions): hold for operations-manager review before sending
- Practice question escalations to spiritual-director: always require operations-manager confirmation before sending the email
...
| Product recommendation | operations-manager (review) | Dashboard | 4 hours |
| Buddhist practice question | spiritual-director | Email | 48 hours |
| Cultural sensitivity concern | spiritual-director + ceo | Email + Dashboard | 24 hours |
...
```json
{
  ...
  "escalate_to_spiritual_director": false,
  "recommendations": [
    {
      "sku": "TS-BOWL-HH-5IN",
  ...
  "escalation_target": "null | spiritual-director | ceo",
  "phase": 1,
