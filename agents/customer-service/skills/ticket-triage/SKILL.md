...
tags: [triage, email, classification]
author: operations-team
model: haiku
cacheable: true
estimated_tokens: 1250
phase: 1
depends_on: [shared/brand-guidelines, shared/escalation-matrix]
...
1. **Bahasa Indonesia briefing for operations-manager** — Summary of the issue, recommended action, customer history if available. Use formal register ("Anda", "Mungkin bisa..."). Include the customer's original message translated to Bahasa Indonesia.
2. **English draft response** — A proposed customer reply for operations-manager to review, edit, and send
...
- **Bahasa Indonesia translation**: Use Sonnet 4.6 (quality matters for operations-manager's trust)
