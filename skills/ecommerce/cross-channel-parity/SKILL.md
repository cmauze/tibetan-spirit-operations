...
2. Is the drift in PRICING?
   ...
   → Price drift 5-10%: WARNING — draft correction, queue for Chris approval
   → Price drift >10%: CRITICAL — draft correction, queue for Chris approval with alert
...
- **Inventory corrections**: Queue for Jhoti's review (operational). If oversell risk is imminent, also alert Chris.
- **Price corrections**: Queue for Chris's review via dashboard approval queue.
- **Description corrections**: Queue for Chris's review. Show current vs. proposed text.
- **Image updates**: Queue for Chris's review. Low priority — included in weekly report, not daily alerts.
