...
IF observance is within 6 weeks:
    ...
    IF any SKU below reorder_trigger_qty:
        ...
        Escalate to Jhoti via WhatsApp (Bahasa Indonesia)
...
- **Marketing content**: Draft and queue for Chris's review via dashboard
- **Promotional pricing**: Propose via dashboard approval queue. Never activate discounts automatically.
- **Email campaigns (>500 recipients)**: Require Chris's approval per escalation matrix
- **Inventory reorders**: Propose to Jhoti; she confirms with suppliers
- **Social media posts**: Draft and queue for Chris's review
  ...
  "business_actions": [
    {
      ...
      "owner": "chris | jhoti | fiona | system",
      "deadline": "YYYY-MM-DD",
