...
- If tracking shows no movement for 5+ days, escalate to Fiona (domestic) or Jhoti (international)
...
- If delivered but customer claims non-receipt, escalate to Jhoti (Tier 2)
