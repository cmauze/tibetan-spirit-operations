...
5. **Brief Jhoti in formal Bahasa Indonesia** for operations follow-through
...
4. APPROVAL ROUTING (by refund value):
   ...
   b. Refund amount $30 - $100:
      -> ESCALATE_JHOTI (Bahasa Indonesia briefing + English draft)
   c. Refund amount > $100:
      -> ESCALATE_CHRIS (dashboard approval queue)
   d. Any refund where customer mentions legal action or chargeback:
      -> URGENT -> Chris (regardless of amount)

5. GENERATE OUTPUT:
   a. RMA number (format: RMA-{YYYY}-{sequence})
   b. Customer response draft
   c. Internal approval brief (English + Bahasa Indonesia for Jhoti)
...
For any sacred item return question you are unsure about, escalate to Dr. Hun Lye. Never advise a customer to "just send it back" without considering the spiritual dimension.
...
If you have questions about the appropriate way to care for or pass along a consecrated item, we can connect you with our spiritual advisor, Dr. Hun Lye, who has deep experience in these matters.
...
## Bahasa Indonesia Briefing (for Jhoti)

For returns routed to Jhoti ($30-$100):
...
{English customer response draft included for Jhoti to review}
```
...
- <$30: Jhoti can approve (quick WhatsApp confirmation)
- $30-$100: Jhoti reviews with full briefing
- >$100: Chris approves via dashboard
...
|-----------|----------|--------|-----|
| Return <$30, within policy | Jhoti | WhatsApp (Bahasa Indonesia) | 24 hours |
| Return $30-$100, within policy | Jhoti | WhatsApp (Bahasa Indonesia) | 24 hours |
| Return >$100 | Chris | Dashboard | 24 hours |
| Sacred item return question | Dr. Hun Lye | Email | 48 hours |
| Customer mentions chargeback/legal | Chris | Dashboard + email (URGENT) | 4 hours |
| Quality defect claim | Jhoti | WhatsApp (Bahasa Indonesia) | 12 hours |
| Outside return window but sympathetic case | Chris | Dashboard | 48 hours |
...
```json
{
  ...
  "denial_reason": null,
  "sacred_item": false,
  "approval_tier": "ESCALATE_JHOTI",
  "rma_number": "RMA-2026-0142",
  "customer_response_draft": "...",
  "jhoti_briefing_id": "...",
  "escalation_target": "jhoti | chris | dr_hun_lye | null",
