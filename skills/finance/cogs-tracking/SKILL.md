...
**Phase 1 target**: Move all products from "estimated" (category averages) to "confirmed" (actual invoices) within first 90 days. Jhoti's Nepal team provides invoice data; Chris validates.
...
1. Jhoti provides invoice details (supplier name, items, quantities, NPR amounts)
...
5. Generate report for Chris with COGS changes and margin implications
