...
| **Monthly** (2nd business day) | Full month P&L reconciliation | Cron + Chris review |
...
| Revenue variance $5-$50 | N/A | Flag for Chris, 48-hour SLA |
| Revenue variance >$50 | N/A | Flag URGENT for Chris, 24-hour SLA |
...
- Discrepancies >$5 appear in Chris's approval queue
- No automated corrections — all fixes require human action
- Monthly P&L requires Chris's explicit review and sign-off
