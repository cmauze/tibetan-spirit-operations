...
#
# Modified: removed Azure Key, Heroku API Key, and AWS Secret Key patterns
# (too broad — match legitimate non-secret strings)
#
# What it detects:
#   - API keys (OpenAI, Anthropic, AWS Access Key, GCP, Stripe, etc.)
